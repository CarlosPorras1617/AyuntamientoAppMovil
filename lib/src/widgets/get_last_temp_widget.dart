    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context,
        ...
        if (snap.hasData) {
          ...
          // if temps hora is diff to 'No se han registrado temperaturas' then shows the hour at AM or PM
          if (temps.first.hora![0] != 'N') {
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    SizedBox(height: _mediaSize.height * 0.01),
                    Text(temps.last.hora.toString(), style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                    if (tempActual! < TemperaturasValues.tempOptima &&
                        tempActual != 0)
                      Column(
                        children: [
